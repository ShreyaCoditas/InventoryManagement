...
//    private String name;
    ...
    @Pattern(
            regexp = "^[A-Za-z][A-Za-z0-9._\\s-]{1,28}[A-Za-z0-9]$",
            message = "Username must be 3-30 characters, start with a letter, and contain only letters, numbers, underscores, hyphens, or spaces"
    )
    private String name;
